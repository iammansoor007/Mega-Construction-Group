...
export default function FAQPage() {
  ...
  const quickInfo = [
    { icon: Phone, label: "Call Us", value: "+1 (917) 295-7776", href: "tel:+19172957776" },
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-gray-900/10"
                ...
                <div className="relative z-10 grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 sm:p-12 lg:p-14 space-y-8">
                    ...
                    {/* Contact cards */}
                    <div className="space-y-3">
                      <a href="tel:+19172957776" className="flex items-center gap-4 p-4 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] transition-all duration-300 group">
                        ...
                        <div>
                          ...
                          <p className="text-white font-semibold text-sm">+1 (917) 295-7776</p>
                        </div>
                      </a>
                  ...
                  <div className="relative p-8 sm:p-12 lg:p-14 flex flex-col justify-center bg-gradient-to-br from-red-600 via-red-600 to-red-700">
                    ...
                    <div className="relative z-10 space-y-7">
                      ...
                      <div className="space-y-3 pt-1">
                        ...
                        <a href="tel:+19172957776" className="block">
                          <motion.div
                            whileHover={{ scale: 1.02 }}
                          ...
                          >
                            <Phone className="w-4 h-4" /> Call +1 (917) 295-7776
                          </motion.div>
                        </a>
                      </div>
