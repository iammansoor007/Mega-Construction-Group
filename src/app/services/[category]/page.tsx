        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <span className="text-red-600 font-bold text-[10px] uppercase tracking-[0.5em] mb-2 block">Technical Capabilities</span>
                    <h2 className="text-4xl md:text-7xl font-bold text-gray-900 tracking-tighter font-heading leading-none">
                ...
                >
                  ...
                  <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end">
                    <div className="relative z-10">
                      <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-red-600/30 backdrop-blur-md border border-red-500/40 text-white text-[10px] font-black uppercase tracking-[0.2em] mb-6 shadow-xl">
                        <span className="w-2 h-2 rounded-full bg-red-500 mr-2 animate-pulse" />
                        Technical Excellence
                      </div>
                      
                      <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 leading-none tracking-tighter drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] group-hover:text-red-400 transition-colors capitalize">
                        {sub.title}
                      </h3>
                      
                      <p className="text-gray-200 text-sm md:text-base leading-relaxed line-clamp-2 max-w-md drop-shadow-md mb-8">
                        {sub.description}
                      </p>
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-white/10 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 flex items-center justify-center group-hover:bg-red-600 group-hover:border-red-600 transition-all duration-700 shadow-2xl">
