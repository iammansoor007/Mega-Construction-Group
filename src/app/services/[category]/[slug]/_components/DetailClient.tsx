            ...
            >
              ...
              <div className="p-6 bg-red-600/5 border-l-4 border-red-600 text-left">
                <p className="text-xs sm:text-sm text-gray-800 leading-relaxed font-medium">
                  <strong>Service Area:</strong> Mega Construction NYC provides expert <strong>{subCategory.title}</strong> services throughout <strong>Manhattan</strong>, <strong>Brooklyn</strong>, <strong>Queens</strong>, <strong>Bronx</strong>, <strong>Staten Island</strong>, and surrounding NY areas. Fully licensed, code-compliant, and ready for immediate deployment.
                </p>
              </div>
