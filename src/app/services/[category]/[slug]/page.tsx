          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tighter leading-[1] md:leading-[0.9] font-heading uppercase break-words">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6 border-y border-gray-100 py-8 md:py-10">
                  {subCategory.stats?.map((stat, i) => (
                      <div key={i} className="flex flex-col border-r border-gray-50 last:border-0 pr-4">
            ...
            >
              <div className="relative rounded-[32px] md:rounded-[60px] overflow-hidden shadow-2xl border-4 md:border-[12px] border-white group">
                ...
                <div className="absolute top-6 right-6 md:top-10 md:right-10 bg-white p-4 md:p-8 shadow-2xl rounded-2xl md:rounded-3xl border border-gray-50">
                    <Building2 className="w-8 h-8 text-red-600 mb-2" />
                    <div className="text-2xl md:text-4xl font-bold text-red-600 tracking-tighter">NY-A+</div>
                    <div className="text-[7px] md:text-[8px] font-bold text-gray-400 uppercase tracking-widest leading-tight mt-1">Structural <br /> Grade Certified</div>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
                  <div className="grid lg:grid-cols-12 gap-10 md:gap-20 items-start mb-16 md:mb-32">
                      <div className="lg:col-span-6">
                          ...
                          <h2 className="text-4xl md:text-8xl font-bold text-gray-900 tracking-tighter font-heading leading-none uppercase">
                  ...
                  <div className="space-y-1">
                      {subCategory.process.map((step, i) => (
                          ...
                          >
                              ...
                              <div className="absolute -left-4 lg:-left-20 top-1/2 -translate-y-1/2 text-[6rem] xs:text-[8rem] sm:text-[12rem] lg:text-[20rem] font-bold text-gray-900/[0.02] group-hover:text-red-600/[0.03] transition-colors pointer-events-none select-none font-heading leading-none">
                                  0{i+1}
                              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              {/* Construction Seal */}
              <div className="absolute -bottom-6 -right-6 md:-bottom-12 md:-right-12 bg-white p-6 md:p-10 shadow-2xl rounded-3xl max-w-[200px] md:max-w-xs border border-gray-50">
                <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-6">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-none bg-red-600 flex items-center justify-center shadow-lg">
                    <ShieldCheck className="w-5 h-5 text-white" />
                  </div>
                  <div className="font-bold text-gray-900 uppercase tracking-widest text-[8px] md:text-[10px]">Material Grade A+</div>
                </div>
                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-24">
                    <div className="lg:col-span-5">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-4 md:gap-6 p-6 md:p-8 bg-white border border-gray-100 shadow-xl rounded-2xl md:rounded-[32px]">
                                <div className="w-12 h-12 md:w-16 md:h-16 rounded-none bg-red-600 flex items-center justify-center text-white shadow-lg flex-shrink-0">
                                    <Construction className="w-5 h-5 md:w-6 md:h-6" />
                                </div>
                                <div>
                                    <div className="text-gray-900 font-bold tracking-tight text-sm md:text-base">Project Hotline</div>
                                    <div className="text-red-600 text-[9px] md:text-[10px] font-bold uppercase tracking-widest">Active 24/7</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {subCategory.faqs.map((faq, i) => (
                            <div key={i} className="group overflow-hidden bg-white border border-gray-100 hover:border-red-600 transition-all duration-500 rounded-none shadow-sm">
                                <button 
                                    ...
                                    className="w-full px-6 py-8 md:px-10 md:py-10 flex items-center justify-between text-left"
                                >
                                    <span className={`text-lg md:text-2xl font-bold tracking-tighter transition-colors ${activeFaq === i ? 'text-red-600' : 'text-gray-900'} pr-4`}>
                                        {faq.question}
                                    </span>
                                    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-none flex items-center justify-center flex-shrink-0 transition-all ${activeFaq === i ? 'bg-red-600 text-white rotate-180' : 'bg-gray-100 text-gray-400'}`}>
                                ...
                                <AnimatePresence>
                                    {activeFaq === i && (
                                        ...
                                        >
                                            <div className="px-6 pb-8 md:px-10 md:pb-12 text-gray-500 text-base md:text-xl font-light leading-relaxed border-t border-gray-50 pt-6 md:pt-8 max-w-3xl">
                                                {faq.answer}
                                            </div>
                                        </motion.div>
                                    )}
        ...
        <section className="py-20 lg:py-40 bg-white">
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 md:mb-20 gap-6">
                    <div>
                        <span className="text-red-600 font-bold text-xs uppercase tracking-[0.4em] mb-4 block">Renovation Ecosystem</span>
                        <h2 className="text-4xl md:text-7xl font-bold text-gray-900 tracking-tighter font-heading leading-none uppercase break-words">
